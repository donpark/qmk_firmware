...
[_QWERTY] = {
  ...
  {MOD_ESC, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT},
...
[_POK3R] = {
  ...
  {KC_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_LEFT, KC_DOWN, KC_RGHT, KC_INS,  KC_DEL},
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case POK3R:
      if (record->event.pressed) {
        set_single_persistent_default_layer(_POK3R);
      }
      return false;
      break;
    case LOWER:
