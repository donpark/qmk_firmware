...
[_BL] = KEYMAP_HHKB(
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,   KC_V,    KC_B,    KC_N,    KC_M,     KC_COMM, KC_DOT, KC_SLSH,                   MT(MOD_RSFT, KC_ENT), MO(_FL), \
  KC_LCTL, KC_LALT, KC_LGUI,                           KC_SPC,                             KC_RGUI, KC_PGDN, MO(_RL), KC_RCTL),
